 ...
 * Update an Item
 */
class prettyworkItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('prettywork_item_err_ns');
		}
...
return 'prettyworkItemUpdateProcessor';
